...
void KeyValueWrapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        KeyValueWrapper *_t = static_cast<KeyValueWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (KeyValueWrapper::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyValueWrapper::appendPlainText)) {
                *result = 0;
            }
        }
        {
            typedef void (KeyValueWrapper::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyValueWrapper::setKeyText)) {
                *result = 1;
            }
        }
        {
            typedef void (KeyValueWrapper::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyValueWrapper::setValueText)) {
                *result = 2;
            }
        }
        {
            typedef void (KeyValueWrapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyValueWrapper::createWidgetSignal)) {
                *result = 3;
            }
        }
        {
            typedef void (KeyValueWrapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyValueWrapper::destroyWidgetSignal)) {
                *result = 4;
            }
        }
        {
            typedef void (KeyValueWrapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyValueWrapper::destroyWidgetSignalBlocking)) {
                *result = 5;
            }
        }
        {
            typedef void (KeyValueWrapper::*_t)(QString , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KeyValueWrapper::addToWindowSignal)) {
                *result = 6;
            }
        }
    }
...
const QMetaObject KeyValueWrapper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_KeyValueWrapper.data,
      qt_meta_data_KeyValueWrapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *KeyValueWrapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KeyValueWrapper.stringdata0))
        return static_cast<void*>(const_cast< KeyValueWrapper*>(this));
