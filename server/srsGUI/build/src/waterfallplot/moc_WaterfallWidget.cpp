...
void WaterfallWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WaterfallWidget *_t = static_cast<WaterfallWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject WaterfallWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_WaterfallWidget.data,
      qt_meta_data_WaterfallWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WaterfallWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WaterfallWidget.stringdata0))
        return static_cast<void*>(const_cast< WaterfallWidget*>(this));
