...
void TextEditWrapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TextEditWrapper *_t = static_cast<TextEditWrapper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TextEditWrapper::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEditWrapper::appendPlainText)) {
                *result = 0;
            }
        }
        {
            typedef void (TextEditWrapper::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEditWrapper::setPlainText)) {
                *result = 1;
            }
        }
        {
            typedef void (TextEditWrapper::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEditWrapper::setWidgetTitle)) {
                *result = 2;
            }
        }
        {
            typedef void (TextEditWrapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEditWrapper::createWidgetSignal)) {
                *result = 3;
            }
        }
        {
            typedef void (TextEditWrapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEditWrapper::destroyWidgetSignal)) {
                *result = 4;
            }
        }
        {
            typedef void (TextEditWrapper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEditWrapper::destroyWidgetSignalBlocking)) {
                *result = 5;
            }
        }
        {
            typedef void (TextEditWrapper::*_t)(QString , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextEditWrapper::addToWindowSignal)) {
                *result = 6;
            }
        }
    }
...
const QMetaObject TextEditWrapper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TextEditWrapper.data,
      qt_meta_data_TextEditWrapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TextEditWrapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TextEditWrapper.stringdata0))
        return static_cast<void*>(const_cast< TextEditWrapper*>(this));
