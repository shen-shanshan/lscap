...
const QMetaObject ComplexWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ComplexWidget.data,
      qt_meta_data_ComplexWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ComplexWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ComplexWidget.stringdata0))
        return static_cast<void*>(const_cast< ComplexWidget*>(this));
