...
void RealWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RealWidget *_t = static_cast<RealWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject RealWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_RealWidget.data,
      qt_meta_data_RealWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RealWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RealWidget.stringdata0))
        return static_cast<void*>(const_cast< RealWidget*>(this));
