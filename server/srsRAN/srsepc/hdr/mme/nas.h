...
public:
  ...
  /****************************** Leap ******************************/
  void leap_send_authentication_reject(s1ap_interface_nas* s1ap);
  void leap_send_detach_request(s1ap_interface_nas* s1ap);
  void leap_send_tau_reject(s1ap_interface_nas* s1ap);
  void leap_send_identity_request(s1ap_interface_nas* s1ap);
  void leap_send_attach_reject(s1ap_interface_nas* s1ap);
  /****************************** Leap ******************************/
  ...
  bool pack_attach_reject(srsran::byte_buffer_t* nas_buffer);
  /****************************** Leap ******************************/
