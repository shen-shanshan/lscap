                                                   ...
                                                   struct sctp_sndrcvinfo*          enb_sri)
{
  ...
  /****************************** Leap ******************************/
  leap_info->leap_nas_msg        = (char*)nas_msg->msg;
  leap_info->leap_nas_msg_size   = (int)nas_msg->N_bytes;
  leap_info->leap_enb_ue_s1ap_id = (int)enb_ue_s1ap_id;
  leap_info->leap_enb_sri        = enb_sri;
  leap_info->leap_m_nas_init     = m_nas_init;
  leap_info->leap_m_nas_if       = m_nas_if;
  /****************************** Leap ******************************/
